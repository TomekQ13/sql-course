...
values ('Germany', 357588, 'Euro');

insert into countries
values ('USA', 9834000, 'US Dollar');

insert into countries
values ('Poland', 322575, 'Zloty');

insert into countries
values ('Switzerland', 41285, 'Swiss frank');

insert into countries
values ('France', 543940, 'Euro');
...
insert into people (id, name, surname, date_of_birth, favourite_color, country, years_experience, cost_living)
values (10, 'Johnny' ,'Smith', '07-JUL-1999', 'blue', 'Denmark', 17, 11000);
